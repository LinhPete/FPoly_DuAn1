...
public class MainPageFrame extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        chart.addLegend("Sản Phẩm", Color.decode("#e65c00"), Color.decode("#f9D423"));
        this.chart();
    }
    ...
    public void chart() {
        chart.clear();
        try {
            List<Object[]> listDT = tkdao.getThongKe();
            for (Object[] row : listDT) {
                chart.addData(new ModelChart(row[0] + "", new double[]{Double.parseDouble(row[2] + "")}));
            }
            chart.start();
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        panelShadow1Layout.setVerticalGroup(
            ...
            .addGroup(panelShadow1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(chart, javax.swing.GroupLayout.DEFAULT_SIZE, 1628, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//        });
    ...
    private void btnDeleteClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteClientActionPerformed
        ...
        if (hddao.selectByID(txtMaKH.getText()) == null) {
            ...
            MsgBox.inform(null, "Xóa khách hàng thất bại");
            return;
        }
