...
public class ChartJDialog extends javax.swing.JDialog {
    ...
    public ChartJDialog(java.awt.Frame parent, boolean modal) {
        ...
        chart.addLegend("Giá Vốn", new Color(135, 189, 245));
        chart.addLegend("Tiền lãi", new Color(189, 135, 245));
        listDT = tkdao.getDTTMonth();
        try {
            for (Object[] row : listDT) {
                chart.addData(new ModelChart(row[0]+"", new double[]{Double.parseDouble(row[2]+""),Double.parseDouble(row[1]+""),Double.parseDouble(row[3]+"")}));
            }
        } catch (Exception e) {
        }
        chart.start();
    ...
    private void initComponents() {
        ...
        panel2Layout.setHorizontalGroup(
            ...
            .addGroup(panel2Layout.createSequentialGroup()
                .addGap(30, 30, 30)
                .addComponent(chart, javax.swing.GroupLayout.PREFERRED_SIZE, 981, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30))
        );
