...
public class EmployeeController {
    ...
    public static void delete() {
        ...
        if(hddao.selectByMaNV(MaNV)!= null){
            MsgBox.inform(null, "Không thể xóa nhân viên này !!");
            return;
        }
        if(MsgBox.confirm(null, "Bạn có muốn xóa nhân viên này ?")){
    ...
    public static NhanVien getForm() {
        ...
        try {
            ...
            MsgBox.inform(null, "Ngày sinh không hợp lệ !");
            return null;
        }
    ...
    private static boolean check(NhanVien nv){
        if(nv.getHoVaTen().equals("") ||
                ...
                nv.getEmail().equals("") ||
                nv.getHinh().equals("")){
            MsgBox.inform(null, "Vui lòng điền đủ thông tin !!");
            return false;
        }
        ...
        if(!Validate.email(nv.getEmail())){
            MsgBox.inform(null, "Sai định dạng email !!");
            return false;
        }
        if(!Validate.phoneNumber(nv.getSDT())){
            MsgBox.inform(null, "Sai định dạng số điện thoại !!");
            return false;
        }
        if(!Validate.checkName(nv.getHoVaTen())){
            MsgBox.inform(null, "Sai định dạng tên !!");
            return false;
        }
        return true;
    }
   ...
   public static void prepareSetImage(String nameFile) {
        try {
            ...
            MsgBox.confirm(null, "Ảnh không có sẵn .");
        }
    }
}
